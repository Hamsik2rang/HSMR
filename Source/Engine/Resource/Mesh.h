...
class HS_API Mesh : public Object
{
public:
    Mesh()
        : Object(EType::MESH)
...
private:
    ...
    // RHI Resources
    RHIBuffer* _positionBuffer   = nullptr;
    RHIBuffer* _texcoordBuffers[8]{};
    RHIBuffer* _normalBuffer     = nullptr;
    RHIBuffer* _colorBuffer      = nullptr;
    RHIBuffer* _tangentBuffer    = nullptr;
    RHIBuffer* _bitangentBuffer  = nullptr;
    RHIBuffer* _boneIDBuffer     = nullptr;
    RHIBuffer* _boneWeightBuffer = nullptr;
    RHIBuffer* _indexBuffer      = nullptr;
};
