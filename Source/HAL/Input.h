...
public:
	...
	HS_FORCEINLINE static void GetMousePosition(uint16& x, uint16& y) { x = s_move.xPoint; y = s_move.yPoint; }
	HS_FORCEINLINE static void GetMouseScrollOffset(uint16& vOffset, uint16& hOffset) { vOffset = s_scroll.vOffset; hOffset = s_scroll.hOffset; }
