...
// ImPlot - HAS_IMPLOT is defined by CMake when ImPlot is available
#ifdef HAS_IMPLOT
#include "implot.h"
#endif
...
void Profiler::DrawUI()
{
    ...
    if (ImGui::Begin("Profiler"))
    {
        ...
        if (ImGui::BeginTabBar("ProfilerTabs"))
        {
            ...
            {
                // GPU timing table
                if (ImGui::BeginTable("GPUTimings", 5,
...
void Profiler::drawFrameTimeGraph()
{
    ...
    ImGui::PlotLines("Frame Time (ms)",
        _frameTimeHistory, _historySize,
        _frameIndex, nullptr,
        0.0f, 33.3f,
        ImVec2(0, 80));
...
{
    if (ImGui::BeginTable("CPUTimings", 5,
